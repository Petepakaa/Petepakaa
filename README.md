...
class SpiderEngineer:
    name        = "Pratik Kumar"
    alias       = "Petepakaa | The Wire Guy"
    location    = "Dwarka, New Delhi, India 🇮🇳"
    university  = "NSUT — B.Tech Electrical Engineering"
...
- 🚁 **DGCA-Certified Drone Pilot Training** — NSUT West Campus, Dept. of Mechanical Engineering *(3 Oct 2024)*
- 💻 **EDA Seminar: Siemens VLSI Design Flow** — Siemens @ NSUT Main Campus, New Delhi *(7 Apr 2025)*
